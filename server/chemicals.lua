...
RegisterServerEvent('DjonStNix-DrugProcessing:pickedUpChemicals', function()
	local src = source
...
RegisterServerEvent('DjonStNix-DrugProcessing:processHydrochloric_acid', function()
	local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('DjonStNix-DrugProcessing:processsodium_hydroxide', function()
	local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('DjonStNix-DrugProcessing:processprocess_sulfuric_acid', function()
	local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('DjonStNix-DrugProcessing:process_lsa', function()
	local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
QBCore.Functions.CreateCallback('DjonStNix-DrugProcessing:validate_items', function(source, cb, data)

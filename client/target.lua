...
CreateThread(function()
    exports.ox_target:addModel("h4_prop_bush_cocaplant_01", {
        {
            event = "DjonStNix-DrugProcessing:pickCocaLeaves",
            icon = "fas fa-leaf",
    ...
    exports.ox_target:addModel("prop_plant_01b", {
        {
            event = "DjonStNix-DrugProcessing:pickHeroin",
            icon = "fas fa-leaf",
    ...
    exports.ox_target:addModel("mw_weed_plant", {
        {
            event = "DjonStNix-DrugProcessing:pickWeed",
            icon = "fas fa-envira",
    ...
    exports.ox_target:addModel("mw_sodium_barrel", {
        {
            event = "DjonStNix-DrugProcessing:pickSodium",
            icon = "fas fa-dna",
    ...
    exports.ox_target:addModel("mw_sulfuric_barrel", {
        {
            event = "DjonStNix-DrugProcessing:pickSulfuric",
    ...
    exports.ox_target:addModel("mw_chemical_barrel", {
        {
            event = "DjonStNix-DrugProcessing:pickChemicals",
    ...
    exports.ox_target:addModel("mw_hydro_barrel", {
        {
            event = "DjonStNix-DrugProcessing:client:hydrochloricacid",
            icon = "fas fa-radiation",

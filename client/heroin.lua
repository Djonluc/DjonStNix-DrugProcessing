...
local function ProcessHeroin()
	...
	if lib.progressBar({
		...
		TriggerServerEvent('DjonStNix-DrugProcessing:processPoppyResin')
...
RegisterNetEvent('DjonStNix-DrugProcessing:ProcessPoppy', function()
...
RegisterNetEvent("DjonStNix-DrugProcessing:processHeroin",function()
	QBCore.Functions.TriggerCallback('DjonStNix-DrugProcessing:validate_items', function(result)
		if result.ret then
			ProcessHeroin()
		else
...
RegisterNetEvent("DjonStNix-DrugProcessing:pickHeroin", function()
	local playerPed = PlayerPedId()
	...
	if nearbyObject and IsPedOnFoot(playerPed) then
		...
		if lib.progressBar({
			...
			TriggerServerEvent('DjonStNix-DrugProcessing:pickedUpPoppy')
			isPickingUp = false
